...
<tr class="apiDef"><td class="apiType"><a href="json.html#group___json" class="ref">Json*</a></td><td><a href="#group___db_1ga1e25cd862a3a7f2d8adaf767f682ab3a" class="nameRef">dbJson</a>(<a href="r.html#osdep.html#group___osdep_1ga4f52f6802d742ebd12c628e69a2bd162" class="ref">cchar</a> *str)</td></tr><tr class="apiBrief"><td>&nbsp;</td><td>Parse a string into Json properties.</td></tr>
...
<tr class="apiDef"><td class="apiType"><a href="#group___db" class="ref">Db*</a></td><td><a href="#group___db_1gaac209e305e6dcfde2d002718e25da034" class="nameRef">dbOpen</a>(<a href="r.html#osdep.html#group___osdep_1ga4f52f6802d742ebd12c628e69a2bd162" class="ref">cchar</a> *path, <a href="r.html#osdep.html#group___osdep_1ga4f52f6802d742ebd12c628e69a2bd162" class="ref">cchar</a> *schema)</td></tr><tr class="apiBrief"><td>&nbsp;</td><td>Open a database.</td></tr>
...
<tr class="apiDef"><td class="apiType">const DbItem*</td><td><a href="#group___db_1gadeae164db0c1433d49c812ffe4f4db40" class="nameRef">dbSetNumber</a>(<a href="#group___db" class="ref">Db</a> *db, <a href="r.html#osdep.html#group___osdep_1ga4f52f6802d742ebd12c628e69a2bd162" class="ref">cchar</a> *model, <a href="r.html#osdep.html#group___osdep_1ga4f52f6802d742ebd12c628e69a2bd162" class="ref">cchar</a> *fieldName, <a href="r.html#osdep.html#osdep_8h_1a168afaa12b2c08e4ae1d11ea4c296e64" class="ref">int64</a> value, <a href="json.html#group___json" class="ref">Json</a> *props, <a href="#struct_db_params" class="ref">DbParams</a> *params)</td></tr><tr class="apiBrief"><td>&nbsp;</td><td>Set an item field value as a number.</td></tr>
<tr class="apiDef"><td class="apiType">void</td><td><a href="#group___db_1ga5465423627f2305a12b75d9851d2e8bb" class="nameRef">dbSetTrigger</a>(<a href="#group___db" class="ref">Db</a> *db, <a href="#group___db_1ga3b5ef1b2e791898d03c85252a13d16db" class="ref">DbTrigger</a> proc, void *arg)</td></tr><tr class="apiBrief"><td>&nbsp;</td><td>Set the database change trigger callback.</td></tr>
...
<tr class="apiDef"><td class="apiName"><a href="#group___db_1ga3b5ef1b2e791898d03c85252a13d16db" class="nameRef">DbTrigger</a></td><td class="apiBrief">Database trigger.</td></tr>
</table>
<a name="Defines"></a>
## Defines
...
<tr class="apiDef">
<td>#define</td><td><a href="#group___db_1gaa246aa0a788f9584fcccadbbb6fd6c42" class="nameRef">DB_JSON</a>&nbsp;&nbsp;&nbsp;<initializer><ref refid="group___db_1ga1e25cd862a3a7f2d8adaf767f682ab3a" kindref="member">dbJson</ref>(str)</initializer></td>
</tr>
...
OneTable schema.
    ...
    <tr><td class="param"><a class="ref" href="#group___db_1ga3b5ef1b2e791898d03c85252a13d16db">DbTrigger</a></td><td><td>trigger</td><td>
Database change notification trigger.
</td>
    <tr><td class="param">void *</td><td><td>triggerArg</td><td>
...
<p>Close a database.</p>
    ...
    <dl><dt>Parameters:</dt><dd>
    <table class="parameters" title="Parameters">
    <tr><td class="param">db</td><td>Database instance returned via <a class="ref" href="#group___db_1gaac209e305e6dcfde2d002718e25da034">dbOpen</a></td>
    </table></dd></dl>
    <dl><dt><b>API</b> Stability:</dt><dd>Evolving.</dd></dl>
    <dl><dt>See Also:</dt><dd>
    </dd></dl>
...
<p>Create a new item.</p>
 ...
 bool upsert : 1; // Update on create if present. Create on update if missing. <br/></td>
    ...
    <dl><dt>Returns:</dt><dd>The created database item. The <a class="ref" href="#struct_db_item">DbItem</a> &quot;name&quot; property is the indexed key value. The value &quot;json&quot; property contains the item values as a cached JSON object. If null, the &quot;value&quot; property contains the item&apos;s value as an unparsed JSON string. Caller must not free the returned item.</dd></dl>
    <dl><dt><b>API</b> Stability:</dt><dd>Evolving.</dd></dl>
    <dl><dt>See Also:</dt><dd>
    </dd></dl>
  </div>
...
<p>Get a field from a matching item from the database.</p>
 ...
 cchar *index; // Name of the index to use. Defaults to &quot;primary&quot;. Currently only supports &quot;primary&quot;. <br/></td>
    ...
    <dl><dt>Returns:</dt><dd>A string containing the required field in the data item.</dd></dl>
    <dl><dt><b>API</b> Stability:</dt><dd>Evolving.</dd></dl>
    <dl><dt>See Also:</dt><dd>
    </dd></dl>
  </div>
</div>
<a name="group___db_1ga1e25cd862a3a7f2d8adaf767f682ab3a"></a>
<div class="api">
  <div class="prototype">
    <a href="json.html#group___json" class="ref">Json</a> *
    dbJson
(<a href="r.html#osdep.html#group___osdep_1ga4f52f6802d742ebd12c628e69a2bd162" class="ref">cchar</a> *str)
  </div>
  <div class="apiDetail">
<p>Parse a string into Json properties.</p>
    <dl><dt>Parameters:</dt><dd>
    <table class="parameters" title="Parameters">
    <tr><td class="param">str</td><td>NULL terminated JSON string.</td>
    </table></dd></dl>
...
<a name="group___db_1gaac209e305e6dcfde2d002718e25da034"></a>
<div class="api">
  <div class="prototype">
    <a href="#group___db" class="ref">Db</a> *
    dbOpen
(<a href="r.html#osdep.html#group___osdep_1ga4f52f6802d742ebd12c628e69a2bd162" class="ref">cchar</a> *path, <a href="r.html#osdep.html#group___osdep_1ga4f52f6802d742ebd12c628e69a2bd162" class="ref">cchar</a> *schema)
  </div>
  <div class="apiDetail">
<p>Open a database.</p>
    <dl><dt>Parameters:</dt><dd>
...
<p>Save the database.</p>
    ...
    <table class="parameters" title="Parameters">
    <tr><td class="param">db</td><td>Database instance.</td>
    <tr><td class="param">filename</td><td>Optional filename to save data to. If set to NULL, the data is saved to the name given when opening the database via <a class="ref" href="#group___db_1gaac209e305e6dcfde2d002718e25da034">dbOpen</a></td>
    </table></dd></dl>
    <dl><dt><b>API</b> Stability:</dt><dd>Evolving.</dd></dl>
    <dl><dt>See Also:</dt><dd>
    </dd></dl>
...
<a name="group___db_1ga179e75663ae8450d15c754ab07f716ad"></a>
<div class="api">
  <div class="prototype">
    const DbItem *
    DbItem* dbSet
...
<a name="group___db_1gadeae164db0c1433d49c812ffe4f4db40"></a>
<div class="api">
  <div class="prototype">
    const DbItem *
    DbItem* dbSetNumber
...
<a name="group___db_1ga5465423627f2305a12b75d9851d2e8bb"></a>
<div class="api">
  <div class="prototype">
    void
    dbSetTrigger
(<a href="#group___db" class="ref">Db</a> *db, <a href="#group___db_1ga3b5ef1b2e791898d03c85252a13d16db" class="ref">DbTrigger</a> proc, void *arg)
  </div>
  <div class="apiDetail">
...
<a name="group___db_1ga3b5ef1b2e791898d03c85252a13d16db"></a>
<div class="api">
  <div class="prototype">
    typedef void(* DbTrigger) (void *arg, struct Db *db, struct DbModel *model, struct DbItem *item, struct DbParams *params, cchar *cmd).
  </div>
  <div class="apiDetail">
<p>Database trigger.</p>
    <dl><dt>Parameters:</dt><dd>
    <table class="parameters" title="Parameters">
    <tr><td class="param">arg</td><td>User argument provided to dbSetTrigger.</td>
    <tr><td class="param">db</td><td>Database instance.</td>
